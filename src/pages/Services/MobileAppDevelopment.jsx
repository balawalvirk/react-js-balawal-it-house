  ...
  return (
    <section className="mt-12">
      ...
      <p className="mt-6 text-[14px] text-left">
        We develop mobile apps that keep your audience engaged on the go,
        delivering seamless experiences across iOS and Android platforms. From
        concept to launch, we prioritize user experience and functionality to
