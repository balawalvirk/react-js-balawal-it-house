  ...
  return (
    <section className="mt-12">
      ...
      <p className="mt-6 text-[14px] text-left">
        From dynamic websites to custom features, we build online experiences
        that captivate your audience and drive results for your business. Our
        collaborative approach ensures that your website not only looks great
        but also meets your business objectives and exceeds user expectations.
      </p>
      <div className="mt-16">
