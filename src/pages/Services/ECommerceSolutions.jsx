  ...
  return (
    <section className="mt-12">
      ...
      <p className="mt-6 text-[14px] text-left">
        We set up online stores that make it easy for your customers to shop
        securely and conveniently, ensuring a seamless experience from browsing
        to checkout. Our e-commerce solutions are tailored to your business
        needs, providing advanced features and integrations to help you maximize
