function TrackRecord() {
  ...
  return (
    <section className="py-[120px] text-center">
      <h1 className="font-bold text-[40px]">Our Proven Track Record</h1>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 mt-16">
        {items?.map((item, index) => (
          <div className="record-card p-[24px] rounded-[24px] bg-[#F5F5F5] sm:grid-cols-6 md:grid-cols-4 text-center" key={index}>
            <h1>{item.stat}</h1>
